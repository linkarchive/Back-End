...
//                .antMatchers("/mark/links/user/{userId}").permitAll()
//                .antMatchers("/links/user/{userId}").permitAll()
//                .anyRequest().authenticated()
                .antMatchers("/link").authenticated()
                .antMatchers("/links/user/").authenticated()
                .antMatchers("/mark/links/user").authenticated()
                .antMatchers("/mark/link/{linkId}").authenticated()
